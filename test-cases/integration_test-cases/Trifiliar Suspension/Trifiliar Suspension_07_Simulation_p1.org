...
* Test Steps
  ...
  4. Click on the calculate button and the click on the reload button
...
* Expected result
  ...
  4. The Moment of Inertia Of Disc should be calculated and should be displayed at the corresponding field
