...
* Test Steps
  ...
  4. Enter the invalid values in the Width(b) Height(d) Length(l) fields
...
* Expected result
  ...
  4. An error message should be displayed on the screen as to enter the valid data in Width(b) Height(d) Length(l) fields
