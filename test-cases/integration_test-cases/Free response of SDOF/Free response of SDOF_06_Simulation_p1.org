...
* Test Steps
  ...
  4. Don't enter the values in X0, Mass and Spring constant fields and click on Cc button
...
* Expected result
  ...
  4. An error message should be displayed on the screen as to enter the values in X0, Mass and Spring constant values.
